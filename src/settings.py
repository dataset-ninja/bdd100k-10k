...
##################################
PROJECT_NAME: str = "BDD100K: Images 10K"
PROJECT_NAME_FULL: str = (
    "BDD100K: A Diverse Driving Dataset for Heterogeneous Multitask Learning (Images 10K)"
)
...
PREVIEW_IMAGE_ID: int = 9215311
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/bdd100k-10k"
